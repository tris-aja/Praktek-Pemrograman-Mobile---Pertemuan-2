  ...
  return (
    <View style={styles.container}>
      ...
      <View
        style={[
          styles.bgCircle,
          { top: -80, left: -60, backgroundColor: "#a855f715" },
        ]}
      />
      <View
        style={[
          styles.bgCircle,
          { bottom: -100, right: -60, backgroundColor: "#6366f110" },
        ]}
      />
      ...
      <View style={styles.cardContainer}>
        ...
        <View style={styles.imageOuterRing}>
          <View style={styles.imageInnerRing}>
            <Image
              source={require("../_image/profile-pic.jpg")}
        ...
        <View style={styles.quoteBox}>
          ...
          <Text style={styles.bioText}>
            Gak perlu buru-buru pengen jadi masterpiece. Nikmati aja setiap
            brush stroke-nya, karena kepuasan asli itu ada di proses 'rendering'
            perjuangan kita.
          </Text>
          <Text
            style={[styles.quoteIcon, { textAlign: "right", marginTop: -10 }]}
          >
            ”
          </Text>
        </View>
